...
#   customlines - lets you inject custom lines into the monitrc snippet, just
#                 pass an array, and it will appear in the configuration file
#
# Actions:
#   The following actions gets taken by this defined type:
#    - creates /etc/monit/conf.d/namevar.monitrc as root:root mode 0400 based
#      on _template_
#
# Requires:
#   - Package["monit"]
